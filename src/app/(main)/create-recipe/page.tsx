...
export default function CreateRecipePage() {
  // 1. State สำหรับนับตัวอักษรและข้อความแบบ Real-time
  const [title, setTitle] = useState("");
  const [description, setDescription] = useState("");
  const [instructions, setInstructions] = useState("");

  // 2. State สำหรับระบบ เพิ่ม/ลบ ส่วนผสม
  ...
  return (
    <div className="min-h-screen bg-[#F5EFD7] font-sans pb-20 overflow-x-hidden">
      ...
      {/* ดึง Navbar มาใช้งานปกติ */}
      <Navbar />

      <main className="w-[95%] max-w-[1200px] mx-auto px-4">
        
        {/* หัวข้อโพสต์ใหม่ */}
        <Link href="/home" className="flex items-center gap-2 text-gray-700 hover:text-black mb-4 w-fit transition">
        ...
        {/* กรอบฟอร์มหลักที่มีเส้นขอบสีเขียวรอบตัวตามแบบ */}
        <div className="bg-white border border-[#71B254] rounded-sm p-8 md:p-10 shadow-sm">
          
          {/* จัดเรียงแถวบนแยกเป็น 3 คอลัมน์ (ซ้าย 2 ส่วนข้อมูลพื้นฐาน | ขวา 1 ส่วนอัปโหลดภาพ) */}
          <div className="grid grid-cols-1 lg:grid-cols-3 gap-12 mb-8">
            
            {/* คอลัมน์ซ้าย: ส่วนที่ 1 และ ส่วนที่ 3 */}
            <div className="lg:col-span-2 flex flex-col gap-8">
                ...
                <div className="flex flex-col gap-5 pl-11">
                  ...
                  <div>
                    ...
                    <div className="relative">
                      ...
                      />
                      {/* นับตัวอักษรแบบ Real-time อยู่ขวาในช่องกรอก */}
                  ...
                  <div>
                    ...
                    <div className="relative">
                      ...
                      />
                      {/* นับตัวอักษรแบบ Real-time อยู่มุมขวาล่างของกล่อง */}
              ...
              {/* [3] Ingredients (จัดวางแบบแนวนอนเรียงกันตามภาพเป๊ะๆ) */}
              <div>
                <div className="flex items-center gap-3 mb-4">
                  ...
                  <div className="flex flex-wrap items-center gap-3">
                    {ingredients.map((ing, index) => (
                      <div key={index} className="flex items-center gap-2">
                        ...
                        />
                        {/* ปุ่มลบกากบาทโผล่เมื่อมีมากกว่า 1 ช่อง */}
                    ...
                    {/* ปุ่มกดเพิ่มช่องส่วนผสมวางต่อท้ายแนวนอน */}
                    <button 
                      type="button"
            ...
            {/* คอลัมน์ขวา: ส่วนที่ 2 (Recipe Images ขนานกับข้อมูลด้านซ้าย) */}
          ...
          {/* ==========================================================
              🌟 [4] Instructions ขยายเลย์เอาต์ออกจาก Grid แถวบน เพื่อทอดยาวเต็มความกว้าง (Full Width)
              ========================================================== */}
          <div className="mb-8">
            <div className="flex items-center gap-3 mb-4">
            ...
            <div className="pl-11">
              {/* rows={12} ดึงความสูงให้ยาวเหยียดสะใจสมส่วนตามรูปภาพเป๊ะๆ */}
              <textarea 
                rows={12} 
          ...
          {/* ==========================================================
              🌟 แถวปุ่มกดด้านล่างสุด จัดแนวขอบกว้างและตัดแบ่งสัดส่วนกึ่งกลางขนานกับแนวกล่องภาพด้านบนพอดี
              ========================================================== */}
          <div className="grid grid-cols-1 lg:grid-cols-3 gap-12 pt-6 border-t border-transparent">
            {/* ปุ่ม Save Draft ยาวครอบคลุมพื้นที่คอลัมน์ฝั่งซ้าย */}
            ...
            {/* ปุ่ม Publish Recipe วางตรงล็อกตรงกันกับกล่องอัปโหลดภาพฝั่งขวาพอดี */}
            <div className="lg:col-span-1">
